...
export const pasoPlanta = [
  ...
  },
  {
    ...
    paso2: require("../../assets/huerto/Tomate_Fase2.png"), 
    paso3: require("../../assets/huerto/Tomate_Fase3.png"), 
    paso4: require("../../assets/huerto/Pepino_Fase4.png"), 
    paso5: require("../../assets/huerto/Pepino_Fase5.png"),
  },
  {
    id: 5,
    title: "Pepper",
    ...
    paso2: require("../../assets/huerto/Tomate_Fase2.png"), 
    paso3: require("../../assets/huerto/Tomate_Fase3.png"), 
    paso4: require("../../assets/huerto/Pimientos_Fase4.png"), 
    paso5: require("../../assets/huerto/Pimientos_Fase5.png"),
  },
  {
    id: 6,
    title: "Lechuga",
    ...
    paso4: require("../../assets/huerto/Lechuga_Fase4.png"), 
    paso5: require("../../assets/huerto/Lechuga_Fase5.png"),
  },
  {
    id: 7,
    title: "Cebolla",
    ...
    paso4: require("../../assets/huerto/Cebollas_Fase4.png"), 
    paso5: require("../../assets/huerto/Cebollas_Fase5.png"),
  },
  {
    id: 8,
    title: "Zanahoria",
    ...
    paso5: require("../../assets/huerto/Zanahoria_Fase5.png"),
  },
  {
    id: 9,
    title: "Espinaca",
    ...
    paso2: require("../../assets/huerto/Frambuesas_Fase2.png"), 
    paso3: require("../../assets/huerto/Frambuesas_Fase3.png"), 
    paso4: require("../../assets/huerto/Espinaca_Fase4.png"), 
    paso5: require("../../assets/huerto/Espinaca_Fase5.png"),
  },
  {
    id: 10,
    title: "Calabacín",
    ...
    paso2: require("../../assets/huerto/Tomate_Fase2.png"), 
    paso3: require("../../assets/huerto/Tomate_Fase3.png"), 
    paso4: require("../../assets/huerto/Calabacin_Fase4.png"), 
    paso5: require("../../assets/huerto/Calabacin_Fase5.png"),
  },
  {
    id: 11,
    title: "Frambuesa",
  ...
  },
  {
    ...
    paso2: require("../../assets/huerto/Frambuesas_Fase2.png"), 
    paso3: require("../../assets/huerto/Frambuesas_Fase3.png"), 
    paso4: require("../../assets/huerto/Limon_Fase4.png"), 
    paso5: require("../../assets/huerto/Limon_Fase5.png"),
  },
  {
    id: 14,
    title: "Tomate cherry",
  ...
  },
  {
    ...
    paso2: require("../../assets/huerto/Frambuesas_Fase2.png"), 
    paso3: require("../../assets/huerto/Frambuesas_Fase3.png"), 
    paso4: require("../../assets/huerto/Albahaca_Fase4.png"), 
    paso5: require("../../assets/huerto/Albahaca_Fase5.png"),
  },
  {
    id: 16,
    title: "Menta",
    ...
    paso2: require("../../assets/huerto/Frambuesas_Fase2.png"), 
    paso3: require("../../assets/huerto/Frambuesas_Fase3.png"), 
    paso4: require("../../assets/huerto/Menta_Fase4.png"), 
    paso5: require("../../assets/huerto/Menta_Fase5.png"),
  },
  {
    id: 17,
    title: "Rabano",
...
export const avatarPictures = [
  ...
  },
  {
    id: 12,
    title: "Muchacho",
    imageSource: require("../../assets/avatars/muchacho.png"),
  },
];
